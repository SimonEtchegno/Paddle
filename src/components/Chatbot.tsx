      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-4 md:bottom-6 md:right-24 w-[90vw] md:w-[380px] h-[500px] max-h-[80vh] bg-[#1a2235] border border-[var(--border)] rounded-2xl shadow-2xl flex flex-col z-[100] overflow-hidden"
          >
            {/* Header */}
            <div className="bg-[var(--primary)] text-white p-4 flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold leading-tight text-sm">Asistente IA</h3>
      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-24 right-4 md:bottom-6 md:right-24 w-12 h-12 bg-[var(--primary)] text-white rounded-full shadow-lg shadow-[var(--primary)]/30 flex items-center justify-center hover:scale-110 transition-transform z-[100] border border-white/10"
          >
