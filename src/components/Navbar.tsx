        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <Image
              ...
              alt={sport === 'futbol' ? "Complejo F5 Peñarol" : (club?.nombre || "Peñarol Pádel")}
              width={40}
              height={40}
            ...
            <div className="flex flex-col justify-center">
              <span className="text-sm sm:text-xl md:text-2xl font-black tracking-tight bg-gradient-to-r from-white via-white to-primary bg-clip-text text-transparent leading-none drop-shadow-sm truncate max-w-[200px] sm:max-w-none">
                {sport === 'futbol' ? "Complejo F5 Peñarol" : (club?.nombre || "Complejo Pádel Peñarol")}
              </span>
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {profile ? (
              <Link href="/perfil" className="hidden sm:flex items-center gap-3 bg-white/5 p-1.5 pr-4 rounded-full border border-white/10 hover:bg-white/10 transition-all group relative">
                <div className="relative">
                  <div className={clsx(
                    "w-9 h-9 rounded-full bg-zinc-900 flex items-center justify-center relative z-10 border border-white/20 overflow-hidden shadow-lg",
